...
\maketitle{%
  ...
  %
  Teaching and learning programming can be intimidating and difficult. One approach to alleviate this could be the use of games. CodeHeist was a prototype platformer video game, developed using agile methodologies within 6 to 8 weeks, that incorporated programming into its mechanics. This proved not to be sufficient time to create a full prototype capable of evaluating this approach, however this was enough time to create the core systems that showed great potential and could be expanded in the future. 
}
