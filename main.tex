...
\maketitle{%
  ...
  %
  Teaching and learning programming can be intimidating and difficult. One approach to alleviate this could be the use of games. CodeHeist was a game developed 
}
