...
\usepackage{tabularx}        % Gives greater flexibilty in tables
...
\usepackage{tcolorbox}       % Adds support for putting boxes around elements
\tcbuselibrary{breakable}    % tcolorbox parameters
\tcbset{
  center,
  colback=white,
  sharp corners=all
...
\usepackage{csquotes}        % Allows for more in-line quotes
\usepackage{svg}             % Allows for the use of svg files

% -----------------------------------------------------------------------------
% Dissertation metadata
% -----------------------------------------------------------------------------
\title{Code Heist}
\subtitle{Creating a platformer to teach programming}
\author{Drewan Rutherford}
\supervisor{Katherine Teehan}
% Degree
\degree{Computer Science}
% \degree{MSc Advanced Computer Science}
\university{Cardiff University: \newline School of Computer Science and Informatics}
\date{July 2026}
...
\copyrightholder{Drewan Rutherford}
\licenseyear{2026}
...
\maketitle{%
  ...
  %
  % This is the abstract: a short, self-contained summary of the dissertation. It should state the problem, methods, and main results so that a reader can understand the scope without reading the full document. Replace with your own abstract.
  %
  Teaching and learning programming can be intimidating and difficult. One approach to alleviate this could be the use of games. CodeHeist was a prototype platformer video game, developed using agile methodologies within 6 to 8 weeks, that incorporates programming into its mechanics. This proved not to be sufficient time to create a full prototype capable of evaluating this approach, however this was enough time to create the core systems that showed great potential and could be expanded in the future. 
}
...
\input{FM/acknowledgements}

\chapter{Source-code and Deployments}\label{ch0:source_and_deployments}
\input{FM/source-code}
...
%\input{C1/qdissc1} % Temporary
\input{C1/chapter1-intro}

\chapter{Background}\label{ch2:background}
\input{C2/chapter2-background}

\chapter{Methodology}\label{ch3:method}
\input{C3/chapter3-method}

\chapter{Requirements}\label{ch4:requirements}
\input{C4/chapter4-requirements}

\chapter{Design and Implementation}\label{ch5:design}
\input{C5/chapter5-design}

\chapter{Results and Evaluation}\label{ch6:results}
\input{C6/chapter6-results}

\chapter{Conclusions and Future Work}\label{ch7:conclusions}
\input{C7/chapter7-con-and-fut}

\chapter{Reflection on Learning}\label{ch8:reflections}
\input{C8/chapter8-reflection}
...
% -----------------------------------------------------------------------------
\appendix
\chapter{CatCode Specification}\label{app:supp}
\input{AA/appendixA}

\chapter{Full Requirement Analysis}\label{app:fullReqAnalysis}
\input{AB/appendixB}

\chapter{Developer Report}\label{app:developerReport}
\input{AC/appendixC}

\chapter{Cut Content}\label{app:cutContent}
\input{AD/appendixD}

\chapter{Survey}\label{app:survey}
\input{AE/appendixE}
