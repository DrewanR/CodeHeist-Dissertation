...
Finally, on the technical side of things, with the exception of rapid prototyping, we will take the time to fully design and document a system as complex as CatCode before writing code, whilst also being less afraid to refactor code for more helpful variable and function names. And never use the variable name \texttt{parent} unless it is a direct parent-child relationship\footnote{In either social or technical sense}.