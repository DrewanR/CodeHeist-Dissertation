...
Location: \textbf{Survey build -- slide 7 onwards}
...
\textbf{Slide 7:} Recreating jumping, requiring \texttt{if}, \texttt{jump()} and some operands.

\textbf{Slide 8:} Recreating jumping and striking, requiring more complex logic and \texttt{swipe}.

\textbf{Slide 9 (unimplemented):} Requires recreating all of CatBot's controllers.

Slide 7 used the same geometry as slide 3, whilst slide 8 used the geometry as slide 5, so have not been included here.
...
\begin{fullwidth}
    \begin{quote}
        ...
        Please play through slides 7 to [TBD] before answering the following questions. Feel free to use the hints and solutions or skip slides.
