...
\begin{itemize}
    ...
    \item Similar to the RPG idea, a rogue-like\footnote{Or rogue-lite in the likely scenario it strays from the Berlin Definition, as described by \citep{destructoidRoguelikeDef}. The exact definition of this genere is a controversial topic.} where items take the form of CatCode. This game could function similar to \citep{SlayTheSpire}, swapping the deck-building for programming where your hand is swapped for a script or scripts.
